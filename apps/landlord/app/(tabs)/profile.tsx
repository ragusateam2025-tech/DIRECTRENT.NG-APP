      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          {isIdentityVerified && (
            <View style={styles.verifiedTag}>
              <Text style={styles.verifiedTagText}>✓ Verified Landlord</Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.completenessCard}>
          <View style={styles.completenessHeader}>
            <Text style={styles.completenessTitle}>Account Completeness</Text>
          ...
          {completeness < 100 && (
            <Text style={styles.completenessHint}>
              {!isIdentityVerified
                ? 'Verify your BVN or NIN to list properties (+20%)'
                : 'Upload ownership documents to publish listings'}
            </Text>
          )}
        </View>
        ...
        <View style={styles.section}>
          ...
          <VerificationRow
            ...
            status="pending"
            onPress={() => router.push('/(verification)/ownership')}
        ...
        {!isIdentityVerified && (
          <View style={styles.ctaBanner}>
            <Text style={styles.ctaTitle}>Start Listing Properties</Text>
            <Text style={styles.ctaSubtitle}>
              Verify your identity and upload ownership documents to start receiving verified tenant applications.
            </Text>
            <View style={styles.ctaRow}>
              <TouchableOpacity style={styles.ctaButton} onPress={() => router.push('/(verification)/bvn')} activeOpacity={0.85}>
                <Text style={styles.ctaButtonText}>Verify BVN</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.ctaButton, styles.ctaButtonOutline]} onPress={() => router.push('/(verification)/nin')} activeOpacity={0.85}>
        ...
        <View style={styles.section}>
          ...
          <MenuRow icon="✏️" label="Edit Profile" onPress={() => {}} />
          <MenuRow icon="🔔" label="Notification Preferences" onPress={() => {}} />
          <MenuRow icon="💰" label="Payment & Payouts" onPress={() => router.push('/payments')} />
          <MenuRow icon="📊" label="Subscription Plan" onPress={() => router.push('/subscription')} />
          <MenuRow icon="🏦" label="Bank Account" onPress={() => router.push('/bank-account')} />
        ...
        <Text style={styles.version}>Directrent v1.0.0 — Landlord App</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
