/**
 * FT-005: NIN Verification Screen (Tenant App)
 * Calls the verifyNin Cloud Function.
 */
  ...
  const handleVerify = useCallback(async () => {
    ...
    try {
      ...
      if (code === 'functions/already-exists') {
        ...
        setError('The name on your NIN does not match your profile name. Update your name in settings to match your NIN.');
      ...
      >
        ...
        >
          ...
          <Text style={styles.subheading}>
            Verify your National Identification Number to unlock messaging and rental applications.
          </Text>

          <View style={styles.infoCard}>
            <Text style={styles.infoTitle}>What is a NIN?</Text>
            <Text style={styles.infoText}>
              Your National Identification Number (NIN) is an 11-digit number assigned by NIMC. Find it on your National ID card, or by dialling{' '}
              <Text style={styles.infoCode}>*346#</Text> on your registered phone.
            </Text>
          </View>
          ...
          <View style={styles.securityNote}>
            <Text style={styles.securityNoteText}>
              🔒 Your NIN is never stored. We only save the last 4 digits and a secure hash for verification purposes — in compliance with NIMC regulations and Nigeria's NDPR.
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  infoCode: { fontFamily: 'monospace', fontWeight: '700', backgroundColor: '#C5CAE9', paddingHorizontal: 4 },
